...
tall = ["height", "Key:building:levels"]
...
extra_keys = {
    ...
    "Q641226": ["leisure=stadium"],  # arena
    "Q2301048": ["aeroway=helipad"],  # special airfield
    "Q622425": ["amenity=pub", "Tag:amenity=music_venue"],  # nightclub
    "Q187456": ["amenity=pub", "Tag:amenity=nightclub"],  # bar
    "Q16917": ["amenity=clinic", "Tag:building=clinic"],  # hospital
    "Q330284": ["amenity=market"],  # marketplace
    "Q5307737": ["amenity=pub", "Tag:amenity=bar"],  # drinking establishment
    "Q875157": ["tourism=resort"],  # resort
    "Q174782": [
        "leisure=park",
        "highway=pedestrian",
        "foot=yes",
    ...
    "Q34627": ["religion=jewish"],  # synagogue
    "Q16970": ["religion=christian"],  # church
    "Q32815": ["religion=islam"],  # mosque
    "Q811979": ["building"],  # architectural structure
    "Q11691": ["building"],  # stock exchange
    "Q1329623": [
        "amenity=arts_centre",  # cultural centre
        "amenity=community_centre",
    ],
    "Q856584": ["amenity=library"],  # library building
    "Q11315": ["landuse=retail"],  # shopping mall
    "Q39658032": ["landuse=retail"],  # open air shopping centre
    "Q277760": ["historic=folly", "Tag:historic=city_gate"],  # gatehouse
    "Q180174": ["historic=folly"],  # folly
    "Q15243209": [
        "leisure=park",
        "boundary=national_park",
    ],  # historic district
    "Q3010369": ["historic=monument"],  # opening ceremony
    "Q123705": ["place=suburb"],  # neighbourhood
    "Q256020": ["amenity=pub"],  # inn
    "Q41253": ["amenity=theatre"],  # movie theater
    "Q17350442": ["amenity=theatre"],  # venue
    "Q156362": ["amenity=winery"],  # winery
    "Q14092": ["leisure=fitness_centre", "Tag:leisure=sports_centre"],  # gymnasium
    "Q27686": [
    ...
    "Q2360219": ["amenity=embassy"],  # permanent mission
    "Q27995042": ["protection_title=Wilderness Area"],  # wilderness area
    "Q838948": ["historic=memorial", "Tag:historic=monument"],  # work of art
    "Q23413": ["place=locality"],  # castle
    "Q28045079": [
    ...
    "Q515": ["border_type=city"],  # city
    "Q1254933": ["amenity=university"],  # astronomical observatory
    "Q1976594": ["landuse=industrial"],  # science park
    "Q190928": ["landuse=industrial"],  # shipyard
    "Q4663385": [
        "historic=train_station",  # former railway station
        "railway=historic_station",
    ],
    "Q11997323": ["emergency=lifeboat_station"],  # lifeboat station
    "Q16884952": [
        "castle_type=stately",
        "building=country_house",
    ],  # country house
    "Q1343246": [
        "castle_type=stately",
        "building=country_house",
    ],  # English country house
    "Q4919932": ["castle_type=stately"],  # stately home
    "Q1763828": ["amenity=community_centre"],  # multi-purpose hall
    "Q3469910": ["amenity=community_centre"],  # performing arts center
    "Q57660343": ["amenity=community_centre"],  # performing arts building
    "Q163740": [
        "amenity=community_centre",  # nonprofit organization
        "amenity=social_facility",
        "social_facility",
    ],
    "Q41176": ["building:levels"],  # building
    "Q44494": ["historic=mill"],  # mill
    "Q56822897": ["historic=mill"],  # mill building
    "Q2175765": ["public_transport=stop_area"],  # tram stop
    "Q179700": [
        "memorial=statue",  # statue
        "memorial:type=statue",
        "historic=memorial",
    ],
    "Q1076486": ["landuse=recreation_ground"],  # sports venue
    "Q988108": [
        "amenity=community_centre",  # club
        "community_centre=club_home",
    ],
    "Q55004558": ["service=yard", "Tag:landuse=railway"],  # car barn
    "Q19563580": ["landuse=railway"],  # rail yard
    "Q134447": ["generator:source=nuclear"],  # nuclear power plant
    "Q1258086": [
        "leisure=park",
        "boundary=national_park",
    ],  # National Historic Site
    "Q32350958": ["leisure=bingo"],  # Bingo hall
    "Q53060": ["historic=gate", "Tag:tourism=attraction"],  # gate
    "Q3947": [
        "tourism=hotel",  # house
        "building=hotel",
        "tourism=guest_house",
    ],
    "Q847017": ["leisure=sports_centre"],  # sports club
    "Q820477": ["landuse=quarry", "Tag:gnis:feature_type=Mine"],  # mine
    "Q77115": ["leisure=sports_centre"],  # community center
    "Q35535": ["amenity=police"],  # police
    "Q16560": ["tourism=attraction", "Tag:historic=yes"],  # palace
    "Q131734": ["amenity=pub", "Tag:industrial=brewery"],  # brewery
    "Q828909": [
        "landuse=commercial",
        "landuse=industrial",
        "historic=dockyard",
    ],  # wharf
    "Q10283556": ["landuse=railway"],  # motive power depot
    "Q18674739": ["leisure=stadium"],  # event venue
    "Q20672229": ["historic=archaeological_site"],  # friary
    "Q207694": ["museum=art"],  # art museum
    "Q22698": [
        "leisure=dog_park",
        "amenity=market",
        "place=square",
    ...
    "Q738570": ["place=suburb"],  # central business district
    "Q1133961": ["place=suburb"],  # commercial district
    "Q935277": ["gnis:ftype=Playa", "Tag:natural=sand"],  # salt pan
    "Q14253637": ["gnis:ftype=Playa", "Tag:natural=sand"],  # dry lake
    "Q63099748": [
        "tourism=hotel",  # hotel building
        "building=hotel",
        "tourism=guest_house",
    ],
    "Q2997369": [
    ...
    "Q130003": [
        "landuse=winter_sports",  # ski resort
        "site=piste",
        "leisure=resort",
...
SELECT DISTINCT ?code WHERE {
  ...
  ?lang wdt:P424 ?code .
    ...
    def criteria(self) -> set[str]:
        ...
        items.discard("amenity")
        items.discard("location")
        items.discard("man_made")
        items.discard("room")
        return items
